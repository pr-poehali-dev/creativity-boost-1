      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="mt-4">
              <h3 className="font-serif text-xl text-foreground">Свет и тень</h3>
              <p className="text-muted-foreground text-sm mt-1">Работа с естественным и искусственным освещением объектов.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-4">
              ...
              <p className="text-muted-foreground text-sm mt-1">Продуманный кадр, который передаёт масштаб и характер здания.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-4">
              <h3 className="font-serif text-xl text-foreground">Сроки</h3>
              <p className="text-muted-foreground text-sm mt-1">Оперативная обработка и передача готовых материалов.</p>
            </div>
          </motion.div>
        </div>
      </div>
